...
public class TabHostNew extends ActionBarActivity implements Notificador {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getResources().getString(R.string.urlFotoPrimera);
        TabHost.TabSpec tab1 = tabHost.newTabSpec(getResources().getString(R.string.tab1));

        TabHost.TabSpec tab3 = tabHost.newTabSpec(getResources().getString(R.string.tab3));
        TabHost.TabSpec tab4 = tabHost.newTabSpec(getResources().getString(R.string.tab4));

        //que queremos que aparezca en las pestañas
        tab1.setIndicator(getResources().getString(R.string.tab1Titulo));
        //tab1.setIndicator("Inicio");//, getResources().getDrawable(R.drawable.home));
        tab1.setContent(R.id.Inicio);


        tab3.setIndicator(getResources().getString(R.string.tab3Titulo));
        tab3.setContent(R.id.AgregarRecital);

        tab4.setIndicator(getResources().getString(R.string.tab4Titulo));
    ...
    public void EnviarAuto(String capacity, String model, String pat) {
        ...
        try {
            jsonObject.put("artista", Validar(reci[0]));
            jsonObject.put("ciudad", Validar(reci[1]));
            jsonObject.put("fecha", Validar(reci[2]));
            jsonObject.put("genero", Validar(reci[3]));
            jsonObject.put("idU", Validar(idU));
            jsonObject.put("modelo", Validar(model));
            jsonObject.put("capacidad", capacity);
            jsonObject.put("patente", Validar(pat));
    ...
    public void Asistira() {
        ...
        try {
            jsonObject.put("artista", Validar(reci[0]));
            jsonObject.put("ciudad", Validar(reci[3]));
            jsonObject.put("fecha", Validar(reci[2]));
            jsonObject.put("genero", Validar(reci[1]));
            jsonObject.put("idU", Validar(idU));
            jsonObject.toString();
    ...
    public void AgregarRecital(String artista, String ciudad, String fecha, String genero, boolean asiste) {
        ...
        try {
            jsonObject1.put("artista", Validar(artista));
            jsonObject1.put("ciudad", Validar(ciudad));
            jsonObject1.put("fecha", fecha);
            jsonObject1.put("genero", Validar(genero));
        ...
        if (asiste) {
            ...
            try {
                jsonObject2.put("artista", Validar(artista));
                jsonObject2.put("ciudad", Validar(ciudad));
                jsonObject2.put("fecha", fecha);
                jsonObject2.put("genero", Validar(genero));
                jsonObject2.put("idU", Validar(idU));
    ...
    public void Actualizar() {
        ...
        try {
            ...
            jsonObject.put("gustos", Validar(gustos));
            jsonObject.put("idU", Validar(idU));
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
    ...
    public void EnviarTelefono(){
        ...
        try {
            jsonObject.put("idU", Validar(idU));
            jsonObject.put("telefono", Validar(Telefono.getText().toString()));
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
